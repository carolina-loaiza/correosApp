function obtenerDatosActualizar() {
    ...
    let sGenero = document.querySelector('#stlGenero');

    let sEdad=Calcularedad();
    aRepartidores.push(sPrimernombre,sSegundonombre,sPrimerapellido,sSegundoapellido,sIdentificacion,sTelefono1,sTelefono2,sFechadenacimiento,sGenero,sEdad);
